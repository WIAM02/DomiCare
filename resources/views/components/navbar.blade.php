    ...
    <div class="p-5 shadow-sm flex justify-between">
        <div class="flex items-center gap-8">
            ...
            <div class="md:flex items-center gap-6 hidden">
                <h2 class="hover:scale-105 hover:text-primary cursor-pointer">Home</h2>
                <h2 class="hover:scale-105 hover:text-primary cursor-pointer">Sevices</h2>
                <h2 class="hover:scale-105 hover:text-primary cursor-pointer">About us</h2>
            </div>
        </div>
        <div>
            @auth
